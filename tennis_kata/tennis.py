...
class TennisGame1:
    ...
    class TennisGame2:
        ...
        def score(self):
            ...
            if (self.player_1_points >= 4 and self.player_2_points >= 0 and (
                    self.player_1_points - self.player_2_points) >= 2):
                result = "Win for " + self.player_1_name
            if (self.player_2_points >= 4 and self.player_1_points >= 0 and (
                    self.player_2_points - self.player_1_points) >= 2):
